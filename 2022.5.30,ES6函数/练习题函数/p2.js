...
// 得到所有电话号码以1结尾的学生
//新写法
// const tel = students.filter((students) => students.tel.endsWith('1'));
// console.log(tel);
...
//新写法
// const result = students.filter((student) =>student.sex === '女')
// .map((student) => ({name:student.name, tel:student.tel}))
// console.log(result);
...
//新写法
// const html = students.map((student) =>`<li>${student.name}</li>`).join('');
// console.log(html);
