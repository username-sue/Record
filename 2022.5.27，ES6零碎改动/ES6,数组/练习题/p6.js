...
//第二种写法；
  // const stud = students.filter(function(students){
  //   return students.sex === '女'
  // })
  // console.log(stud);
...
// 得到所有女生的姓名和电话号码 [ {name:'monica', tel:'18122223333'} ]
  ...
  //   for ( const key of students){
  //       if(key.sex === '女'){
  //         arr.push(`{name:${key.name}, tel:${key.tel}}`);
  //       }
  //     }
  //     console.log(arr);
  ...
  //   return {name:student.name,tel:student.tel};
  // })
  //   console.log(result);
...
//      arr.push(key.age);
//     }
//    const age = arr.reduce(function(a,b){
//       return a + b;
//     },0)
//     console.log(age);
...
//     for ( const key of students){
//       obj.id.push(key.id);
//       obj.name.push(key.name);
//       obj.sex.push(key.sex);
//       obj.age.push(key.age);
//       obj.address.push(key.address);
//       obj.tel.push(key.tel);
//       }
//       console.log(obj);
...
//  })
//  .some(function(students){
//    return students.age > 28;
//  })
//  console.log(result);
